(() => {
  const TEXT = {
    "zh-CN": {
      ...
      overallOpacityHelp: "同时调整视频和活动列表的透明度。100% 完全可见，0% 完全透明。默认 80%。",
      random: "随机播放",
      sequence: "顺序播放",
      addVideo: "添加视频",
      restoreDefault: "恢复默认",
    ...
    en: {
      ...
      overallOpacityHelp: "Adjusts the opacity of both the video and activity panel. 100% is fully visible; 0% is fully transparent. Default: 80%.",
      random: "Random",
      sequence: "Sequential",
      addVideo: "Add Video",
